...
var remote = {
  ...
  branch: 'test',
  website: '222222.com/h5-fe/sec-kill',
  static: true,
};
...
//await moveDir('build/cashier-h5', 'build/');
//await copyDir('build/cashier-h5', 'build');
  var branch = process.argv[3] || 'test'
  var cm = process.argv[4] || 'auto deploy' 
  remote.branch = branch
  if(branch!=='test'&&branch!=='release'){
  ...
  if (process.argv.includes('--static')) {
    ...
    //   nosort: true,
    //   dot: true,
    //   ignore: ['build/.git', 'build/public', 'build/cashier-h5'],
    // });
